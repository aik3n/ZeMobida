...
VERSIÓN ACTUAL: 13
ESTADO: v12 estable cerrada. v13 comienza desde este punto.
...
"la sincronización con GitHub ha terminado correctamente".
...
Las condiciones comprueban que el jugador tenga todos los objetos indicados.
...
- CUEVA tiene su opción comentada.
- CASTILLO tiene su opción comentada.
- NAVE no tiene opciones.
- CASA no tiene opciones.
...
Esto permite saltar automáticamente a TODO cuando el inventario contiene ambos objetos.


Opciones:

1 Comprar avion > AVION [+AvioN, xp+1]

2 Comprar tren > TREN[+TrEn, xp+5]
...
El funcionamiento depende de la normalización de nombres de objetos.
...
DialogueManager="*uid://f1sgplooah7b"
DialogueUpdater="*uid://byytdewda136x"
...
7. guiones_disponibles significa que existen guiones utilizables y el juego puede continuar.
...
10. No se actualiza innecesariamente el estado mientras el Panel de Estado está oculto.
...
==================================================
24. INICIO DE LA VERSIÓN 13
==================================================

La versión 13 comienza EXACTAMENTE desde el estado descrito en este documento.


Estado:

- v12 estable.
- Sincronización de guiones funcional.
- PanelCargaEscenas bloqueado durante la preparación.
- PanelGeneral siempre habilitado.
- guiones_disponibles representa disponibilidad de contenido.
- sync_failed representa fallo de sincronización.
- Si la sincronización falla, se continúa con los guiones locales.
- UI global independiente de nombres de mapas.
- Panel Estado funcional.
- Inventario funcional.
- XP funcional.
- Guardado/carga funcional.
- Sistema de diálogos funcional.
- PNJ funcional.
- Parser y Validator funcionales.
